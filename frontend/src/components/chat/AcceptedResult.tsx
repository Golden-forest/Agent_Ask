    ...
    return (
        <section className="w-full animate-slide-up" aria-label="Accepted prompt">
            <div className="mb-5 flex items-center gap-2">
                ...
                <span className="font-rounded text-sm font-semibold text-success">Accepted</span>
            </div>

            <div className="mb-7">
                <h2 className="font-rounded text-[13px] font-semibold text-textSecondary">Requirement Summary</h2>
            ...
            <div className="overflow-hidden rounded-[22px] border border-border/10 bg-surface">
                <div className="flex items-center justify-between border-b border-border/10 px-5 py-4 sm:px-6">
                    <h2 className="font-rounded text-sm font-semibold text-text">Optimized Prompt</h2>
                    <button
                        type="button"
                        onClick={handleCopy}
            ...
            {notes && (
                <div className="mt-5 rounded-[18px] border border-border/10 bg-surface/55 px-5 py-4">
                    <h2 className="font-rounded text-[13px] font-semibold text-textSecondary">Implementation Notes</h2>
