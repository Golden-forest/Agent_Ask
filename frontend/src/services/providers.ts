...
export const PROVIDERS: Record<ProviderId, Provider> = {
  ...
  openai: {
    ...
    models: [
      ...
      { id: 'gpt-5.6-luna', name: 'GPT-5.6 Luna (高性价比)' },
      { id: 'gpt-5.5', name: 'GPT-5.5' },
      { id: 'gpt-5', name: 'GPT-5' },
      { id: 'gpt-4o', name: 'GPT-4o (遗留)' },
      { id: 'gpt-4o-mini', name: 'GPT-4o Mini (遗留)' },
    ],
  ...
  claude: {
    ...
    models: [
      ...
      { id: 'claude-sonnet-5', name: 'Claude Sonnet 5 (Agent专用)' },
  ...
  gemini: {
    ...
    models: [
      { id: 'gemini-3.6-flash', name: 'Gemini 3.6 Flash (最新)' },
  ...
  qwen: {
    ...
    models: [
      { id: 'qwen-3.6-plus', name: 'Qwen 3.6-Plus (顶榜)' },
